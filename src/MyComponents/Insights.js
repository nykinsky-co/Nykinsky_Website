...
<label htmlFor="menu-btn" className="btn menu-btn"><FontAwesomeIcon icon={faBars} /></label>
  ...
  <div style={{ height: '115px' }}></div>
            ...
            {/* Mid Section */}
            <div id="main-section1"  className="landing-page-main mid-section about dark-theme" style={{paddingTop:'500px'}} >
    <div className="left-aligned">
      <div style={{ display: 'flex', alignItems: 'center' }}>
       
        <div style={{ flex: '1' }}>
          <div style={{color:'white'}}>
            <h4  style={{paddingBottom:'500px'}}><b>Under Construction </b> 
            <br />
            <br />
               <b> Comming Soon......</b>
            </h4>
